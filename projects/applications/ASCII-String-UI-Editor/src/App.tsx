    ...
    <div className="min-h-screen bg-[#0f0f0f] text-[#e8e8e8]">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-[#a0a0a0]">
                Design and export box-drawing characters
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <div className="bg-[#1a1a1a] border border-[#333333] rounded-lg overflow-hidden">
            <div className="px-6 py-4 border-b border-[#333333] bg-[#242424]">
              ...
              <p className="text-sm text-[#a0a0a0]">
                Edit characters to update all previews in real-time
              </p>
            </div>

            <div className="px-6 py-3 border-b border-[#333333] bg-[#0f0f0f]">
              <label className="block text-xs text-[#a0a0a0] mb-2 uppercase tracking-wider">
                Load Preset
              </label>
              <select
          ...
          <div className="bg-[#1a1a1a] border border-[#333333] rounded-lg overflow-hidden">
            <div className="px-6 py-4 border-b border-[#333333] bg-[#242424]">
              ...
              <p className="text-sm text-[#a0a0a0]">
                Click any preview to copy - Updates as you edit
              </p>
            </div>
            ...
            <div className="h-[500px] overflow-y-auto p-6 space-y-4">
              {previews.map((preview, idx) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <pre className="font-mono text-sm text-[#e8e8e8] whitespace-pre">
                      {preview.content}
                    </pre>
                  </div>
                </div>
          ...
          <div className="p-6">
            {displayChars.length === 0 ? (
              <div className="text-center py-12 text-[#707070] italic">
                {searchQuery
                  ? "No characters found"
                  : "Select a category to browse characters"}
              </div>
            ) : (
              <div className="grid grid-cols-6 sm:grid-cols-8 md:grid-cols-10 lg:grid-cols-12 gap-3">
                {displayChars.map((char, idx) => (
                  ...
                  >
                    <span className="text-2xl font-mono mb-1">
                      {char.symbol}
                    </span>
      ...
      <footer className="mt-12 border-t border-[#333333] bg-[#1a1a1a] py-4">
        <div className="max-w-7xl mx-auto px-6 text-center text-sm text-[#707070]">
          Press{" "}
          <kbd className="px-2 py-1 bg-[#242424] border border-[#333333] rounded text-xs">
            ?
          </kbd>{" "}
