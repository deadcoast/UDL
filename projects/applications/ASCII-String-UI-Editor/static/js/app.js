...
function setupEventListeners() {
  ...
  document
    ...
    .addEventListener("click", () => exportCode("python"));
  document
    .getElementById("exportJS")
    .addEventListener("click", () => exportCode("javascript"));
  document.getElementById("copyBtn").addEventListener("click", copyPreview);
  document
    .getElementById("refreshBtn")
    .addEventListener("click", () => parseAndRender());
  document
    .getElementById("copyAllPatternsBtn")
    .addEventListener("click", copyAllPatterns);

  document.getElementById("clearBtn").addEventListener("click", clearEditor);
  document
    .getElementById("undoBtn")
    .addEventListener("click", () => editor?.trigger("keyboard", "undo", null));
  document
    .getElementById("redoBtn")
    .addEventListener("click", () => editor?.trigger("keyboard", "redo", null));
  ...
  document
    .getElementById("showAllCategoriesBtn")
...
function handleSearch(e) {
  ...
  const results = allCharacters.filter(
    (char) => char.label.toLowerCase().includes(query) || char.symbol === query,
  );
...
function displayNoResults() {
  const grid = document.getElementById("characterGrid");
  grid.innerHTML =
    '<div class="no-results">No characters found matching your search</div>';
}
...
function showPalettePlaceholder() {
  const grid = document.getElementById("characterGrid");
  grid.innerHTML =
    '<div class="palette-placeholder">Select a category to browse characters</div>';
}
