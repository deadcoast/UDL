...
def render_2x2_grid(charset: dict) -> str:
    ...
    lines.append(
        c["vertical"] + " Header  " + c["vertical"] + " Header  " + c["vertical"]
    )
    ...
    lines.append(
        c["vertical"] + " Data    " + c["vertical"] + " Data    " + c["vertical"]
    )
...
def generate_all_patterns(charset: dict) -> list[dict]:
    ...
    return [
        ...
        {"title": "Simple Frame", "content": render_simple_frame(charset)},
        {"title": "Single Cell", "content": render_single_cell(charset)},
        {"title": "Wide Header Box", "content": render_wide_header(charset)},
    ]
